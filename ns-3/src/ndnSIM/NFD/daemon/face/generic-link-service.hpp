...
private: // receive path
   ...
   */
  void
  doReceivePacket(const Block& packet, const EndpointId& endpoint, double snr = 0.0, double rssi = 0.0) OVERRIDE_WITH_TESTS_ELSE_FINAL;
   ...
   */
  void
  decodeNetPacket(const Block& netPkt, const lp::Packet& firstPkt, const EndpointId& endpointId, double snr = 0.0, double rssi = 0.0);
   ...
   */
  void
  decodeInterest(const Block& netPkt, const lp::Packet& firstPkt, const EndpointId& endpointId, double snr = 0.0, double rssi = 0.0);
   ...
   */
  void
  decodeData(const Block& netPkt, const lp::Packet& firstPkt, const EndpointId& endpointId, double snr = 0.0, double rssi = 0.0);
   ...
   */
  void
  decodeNack(const Block& netPkt, const lp::Packet& firstPkt, const EndpointId& endpointId, double snr = 0.0, double rssi = 0.0);
