...
void
LinkService::receiveInterest(const Interest& interest, const EndpointId& endpoint, double snr, double rssi)
{
  NFD_LOG_FACE_TRACE(__func__);
...
void
LinkService::receiveData(const Data& data, const EndpointId& endpoint, double snr, double rssi)
{
  NFD_LOG_FACE_TRACE(__func__);
...
void
LinkService::receiveNack(const ndn::lp::Nack& nack, const EndpointId& endpoint, double snr, double rssi)
{
  NFD_LOG_FACE_TRACE(__func__);
