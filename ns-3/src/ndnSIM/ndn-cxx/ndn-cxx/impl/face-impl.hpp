...
public: // consumer
                       ...
                       const TimeoutCallback& afterTimeout)
  {
    ...
    addFieldFromTag<lp::LltcConsumerIdField, lp::LltcConsumerIdTag>(lpPacket, interest2);

    // RNTP extension
//    addFieldFromTag<lp::LltcHopCountField, lp::LltcHopCountTag>(lpPacket, interest2);
//    addFieldFromTag<lp::LltcRreqIDField, lp::LltcRreqIDTag>(lpPacket, interest2);
//    addFieldFromTag<lp::LltcDestNodeIDField, lp::LltcDestNodeIDTag>(lpPacket, interest2);
//    addFieldFromTag<lp::LltcDestSeqNoField, lp::LltcDestSeqNoTag>(lpPacket, interest2);
//    addFieldFromTag<lp::LltcOrigNodeIDField, lp::LltcOrigNodeIDTag>(lpPacket, interest2);
//    addFieldFromTag<lp::LltcOrigSeqNoField, lp::LltcOrigSeqNoTag>(lpPacket, interest2);
...
public: // producer
  ...
  asyncPutData(const Data& data)
  {
    ...
    addFieldFromTag<lp::LltcConsumerIdField, lp::LltcConsumerIdTag>(lpPacket, data);
    addFieldFromTag<lp::LltcSnrField, lp::LltcSnrTag>(lpPacket, data);
