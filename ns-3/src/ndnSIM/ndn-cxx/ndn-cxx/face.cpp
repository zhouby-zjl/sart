...
extractLpLocalFields(NetPkt& netPacket, const lp::Packet& lpPacket)
{
  ...
  addTagFromField<lp::LltcConsumerIdTag, lp::LltcConsumerIdField>(netPacket, lpPacket);
  addTagFromField<lp::LltcSnrTag, lp::LltcSnrField>(netPacket, lpPacket);

//  addTagFromField<lp::LltcHopCountTag, lp::LltcHopCountField>(netPacket, lpPacket);
//  addTagFromField<lp::LltcRreqIDTag, lp::LltcRreqIDField>(netPacket, lpPacket);
//  addTagFromField<lp::LltcDestNodeIDTag, lp::LltcDestNodeIDField>(netPacket, lpPacket);
//  addTagFromField<lp::LltcDestSeqNoTag, lp::LltcDestSeqNoField>(netPacket, lpPacket);
//  addTagFromField<lp::LltcOrigNodeIDTag, lp::LltcOrigNodeIDField>(netPacket, lpPacket);
//  addTagFromField<lp::LltcOrigSeqNoTag, lp::LltcOrigSeqNoField>(netPacket, lpPacket);
